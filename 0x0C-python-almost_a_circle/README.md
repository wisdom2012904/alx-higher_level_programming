...
In this project, I have practised object-oriented programming in python by coding three connected classes to represent rectangles and squares. I wrote my own mytest suite using the unittest module to test all functionality for each class.
